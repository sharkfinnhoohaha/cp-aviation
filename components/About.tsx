      ...
      <div className="max-w-5xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
          <div className="md:col-span-5">
            ...
            <div className="w-12 h-1 bg-jacRed mb-8" />
            <div className="fly-wrap mb-6">
          ...
          <div className="md:col-span-7 grid grid-cols-2 gap-4">
            {regularStats.map((stat, i) => (
              <div key={i} className="p-6 border border-gray-100 bg-jacLight flex flex-col items-center justify-center text-center">
                <span className="text-3xl font-bold text-jacRed mb-2 font-mono">{stat.value}</span>
                <span className="text-xs tracking-widest text-gray-500 font-mono">{stat.label}</span>
              </div>
            ))}
            {fullWidthStats.map((stat, i) => (
              <div key={i} className="p-6 border border-gray-100 bg-jacLight flex flex-col items-center justify-center text-center col-span-2">
                <span className="text-sm font-semibold text-jacDark mb-2">{stat.subtitle}</span>
