...
export default function Specialty({ specialty }: SpecialtyProps) {
  return (
    <section id="specialty" className="py-24 relative z-10 bg-jacLight">
      <div className="max-w-5xl mx-auto px-6 text-center">
        ...
        <div className="fly-wrap mb-8">
          <h2 className="fly-text scroll-fly text-3xl md:text-5xl font-bold font-sans text-jacDark tracking-tight">
            {specialty.title}
          </h2>
        </div>
